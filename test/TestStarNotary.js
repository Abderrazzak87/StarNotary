...
it('can add the star name and star symbol properly', async() => {
    ...
    let user1 = accounts[1];
    let instance = await StarNotary.deployed();
    await instance.createStar('Star 1', tokenId, {from: user1});
...
it('lets a user transfer a star', async() => {
    ...
    let user2 = accounts[2];
    let instance = await StarNotary.deployed();
    await instance.createStar('Star 9', tokenId, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let user1 = accounts[1];
    let instance = await StarNotary.deployed();
    await instance.createStar('Star 10', tokenId, {from: user1});
    assert.equal(await instance.lookUptokenIdToStarInfo(tokenId), 'Star 10');
});
